...
ActiveRecord::Schema.define(version: 2020_09_08_203828) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string "linked_in"
    t.string "twitter"
    t.boolean "open_to_connect", default: false
    t.boolean "open_to_mentor", default: false
    t.boolean "available_to_work", default: false
    t.boolean "saved"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  end
